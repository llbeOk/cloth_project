<script setup>
import { GetCloth } from "../request/api";
</script>
<template>
  <el-dialog v-model="Dressdialog" title="布料详情" width="50%">
        ...
        <div class="main">
          <div class="show">
            <el-card v-for="item in DressCard" :key="item.ID">
              ...
              <span>{{  item.Name }}</span>
              <span style="color:#909399;font-size:10px;margin-left: 10px;">
              类型：{{ item.Type }}
              </span>
